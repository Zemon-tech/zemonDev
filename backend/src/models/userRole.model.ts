...
UserRoleSchema.index({ userId: 1, role: 1 }); // For checking user roles
UserRoleSchema.index({ userId: 1, channelId: 1, role: 1 }, { unique: true }); // One role per user per channel
