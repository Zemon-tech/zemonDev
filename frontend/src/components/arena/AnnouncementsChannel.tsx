...
import { PlusCircle, Pin, Loader2, AlertCircle, Plus, Image, Gift, Smile, User, MessageSquare } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
                          ...
                          <DropdownMenuContent className="w-48" align="start">
                            <DropdownMenuLabel className="flex items-center gap-2">
                              ...
                              <div className="flex flex-col">
                                <span className="font-medium">{getMessageDisplayName(message)}</span>
                                <span className="text-xs text-base-content/60">@{message.username}</span>
                              </div>
                            </DropdownMenuLabel>
                            <DropdownMenuSeparator />
                            <DropdownMenuItem 
                              onClick={() => {
                                ...
                                window.open(`/profile/${message.username}`, '_blank');
                              }}
                            ...
                            <DropdownMenuItem 
                              onClick={() => {
                                ...
                                window.open(`/${currentUser}/arena?dm=${message.username}`, '_blank');
                              }}
                              className="flex items-center gap-2 cursor-pointer"
                            >
